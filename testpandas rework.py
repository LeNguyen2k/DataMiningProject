...
def deviation(n):
    ...
    s = (s/(len(n)-1))**0.5
    return s
#If the StudentsPerformance.csv in the same folder change pd.read_csv('C:/Users/Admin/Downloads/StudentsPerformance.csv') to pd.read_csv('StudentsPerformance.csv')
...
conditions = [((data['math score']>=50) & (data['reading score']>=50) & (data['writing score']>=50)),((data['math score']<50) | (data['reading score']<50) | (data['writing score']<50))]
values = ['pass','fail']
...
math_score_quantity = [data["math score"][(data["math score"]>((i-1)*10)) & (data["math score"]<=(i*10))].count() for i in range (11)]
plt.subplot(3,1,1)
...
reading_score_quantity = [data["reading score"][(data["reading score"]>((i-1)*10)) & (data["reading score"]<=(i*10))].count() for i in range (11)]
plt.subplot(3,1,2)
...
writing_score_quantity = [data["writing score"][(data["writing score"]>((i-1)*10)) & (data["writing score"]<=(i*10))].count() for i in range (11)]
plt.subplot(3,1,3)
...
pltparent_lv_edu = plt.figure("Math, Reading and Writing average, max,min and deviation results in parent level of education")
parent_lv_edu_type = ["high school","college","associate's degree","bachelor's degree","master's degree"]

#Math

math_by_parent_lv_edu_average = [average(data["math score"][data["parental level of education"]==parent_lv_edu_type[i]]) for i in range (5)]
math_by_parent_lv_edu_deviation = [deviation(data["math score"][data["parental level of education"]==parent_lv_edu_type[i]]) for i in range (5)]
math_by_parent_lv_edu_max =[data["math score"][data["parental level of education"]==parent_lv_edu_type[i]].max() for i in range (5)]
math_by_parent_lv_edu_min =[data["math score"][data["parental level of education"]==parent_lv_edu_type[i]].min() for i in range (5)]
plt.subplot(3,1,1)
...
reading_by_parent_lv_edu_average = [average(data["reading score"][data["parental level of education"]==parent_lv_edu_type[i]]) for i in range (5)]
reading_by_parent_lv_edu_deviation = [deviation(data["reading score"][data["parental level of education"]==parent_lv_edu_type[i]]) for i in range (5)]
reading_by_parent_lv_edu_max =[data["reading score"][data["parental level of education"]==parent_lv_edu_type[i]].max() for i in range (5)]
reading_by_parent_lv_edu_min =[data["reading score"][data["parental level of education"]==parent_lv_edu_type[i]].min() for i in range (5)]
plt.subplot(3,1,2)
...
writing_by_parent_lv_edu_average = [average(data["writing score"][data["parental level of education"]==parent_lv_edu_type[i]]) for i in range (5)]
writing_by_parent_lv_edu_deviation = [deviation(data["writing score"][data["parental level of education"]==parent_lv_edu_type[i]]) for i in range (5)]
writing_by_parent_lv_edu_max =[data["writing score"][data["parental level of education"]==parent_lv_edu_type[i]].max() for i in range (5)]
writing_by_parent_lv_edu_min =[data["writing score"][data["parental level of education"]==parent_lv_edu_type[i]].min() for i in range (5)]
plt.subplot(3,1,3)
...
reading_by_lunch_max =[data["reading score"][data["parental level of education"]==lunch_type[i]].max() for i in range (2)]
reading_by_lunch_min =[data["reading score"][data["parental level of education"]==lunch_type[i]].min() for i in range (2)]
plt.subplot(3,1,2)
...
writing_by_lunch_max =[data["writing score"][data["parental level of education"]==lunch_type[i]].max() for i in range (2)]
writing_by_lunch_min =[data["writing score"][data["parental level of education"]==lunch_type[i]].min() for i in range (2)]
plt.subplot(3,1,3)
...
math_by_test_preparation_average = [average(data["math score"][data["test preparation course"]==test_prepartion_type[i]]) for i in range (2)]
math_by_test_preparation_deviation = [deviation(data["math score"][data["test preparation course"]==test_prepartion_type[i]]) for i in range (2)]
math_by_test_preparation_max =[data["math score"][data["test preparation course"]==test_prepartion_type[i]].max() for i in range (2)]
math_by_test_preparation_min =[data["math score"][data["test preparation course"]==test_prepartion_type[i]].min() for i in range (2)]
plt.subplot(3,1,1)
...
reading_by_test_preparation_average = [average(data["reading score"][data["test preparation course"]==test_prepartion_type[i]]) for i in range (2)]
reading_by_test_preparation_deviation = [deviation(data["reading score"][data["test preparation course"]==test_prepartion_type[i]]) for i in range (2)]
reading_by_test_preparation_max =[data["reading score"][data["test preparation course"]==test_prepartion_type[i]].max() for i in range (2)]
reading_by_test_preparation_min =[data["reading score"][data["test preparation course"]==test_prepartion_type[i]].min() for i in range (2)]
plt.subplot(3,1,2)
...
writing_by_test_preparation_average = [average(data["writing score"][data["test preparation course"]==test_prepartion_type[i]]) for i in range (2)]
writing_by_test_preparation_deviation = [deviation(data["writing score"][data["test preparation course"]==test_prepartion_type[i]]) for i in range (2)]
writing_by_test_preparation_max =[data["writing score"][data["test preparation course"]==test_prepartion_type[i]].max() for i in range (2)]
writing_by_test_preparation_min =[data["writing score"][data["test preparation course"]==test_prepartion_type[i]].min() for i in range (2)]
plt.subplot(3,1,3)
...
for i in range(6):
    mathper[i] = data["Extra study math percentage"][(data["Extra study math percentage"]>((i-1)*25)) & (data["Extra study math percentage"]<=(i*25))].count()
    if i == 5:
...
for i in range(6):
    readingper[i] = data["Extra study reading percentage"][(data["Extra study reading percentage"]>((i-1)*25)) & (data["Extra study reading percentage"]<=(i*25))].count()
    if i == 5:
...
for i in range(6):
    writingper[i] = data["Extra study writing percentage"][(data["Extra study writing percentage"]>((i-1)*25)) & (data["Extra study writing percentage"]<=(i*25))].count()
    if i == 5:
...
mathguessmin = [data["math_guess_min"][(data["math_guess_min"]>((i-1)*10)) & (data["math_guess_min"]<=(i*10))].count()for i in range (11)]
mathguessmax = [data["math_guess_max"][(data["math_guess_max"]>((i-1)*10)) & (data["math_guess_max"]<=(i*10))].count()for i in range (11)]
math_score_range= ["0","1-10","11-20","21-30","31-40","41-50","51-60","61-70","71-80","81-90","91-100"]
plt.subplot(3,1,1)
...
readingguessmin = [data["reading_guess_min"][(data["reading_guess_min"]>((i-1)*10)) & (data["reading_guess_min"]<=(i*10))].count()for i in range (11)]
readingguessmax = [data["reading_guess_max"][(data["reading_guess_max"]>((i-1)*10)) & (data["reading_guess_max"]<=(i*10))].count()for i in range (11)]
reading_score_range= ["0","1-10","11-20","21-30","31-40","41-50","51-60","61-70","71-80","81-90","91-100"]
plt.subplot(3,1,2)
...
writingguessmin = [data["writing_guess_min"][(data["writing_guess_min"]>((i-1)*10)) & (data["writing_guess_min"]<=(i*10))].count()for i in range (11)]
writingguessmax = [data["writing_guess_max"][(data["writing_guess_max"]>((i-1)*10)) & (data["writing_guess_max"]<=(i*10))].count()for i in range (11)]
writing_score_range= ["0","1-10","11-20","21-30","31-40","41-50","51-60","61-70","71-80","81-90","91-100"]
plt.subplot(3,1,3)
